...
test('Metric', t => {
  ...
  t.truthy(_rec._expr(_rec._capt(_rec._capt(db, 'arguments/0/object').Metric, 'arguments/0'), {
    content: 't.truthy(db.Metric, \'Metric service should exist\')',
    ...
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"db","range":[9,11]},{"type":{"label":"."},"range":[11,12]},{"type":{"label":"name"},"value":"Metric","range":[12,18]},{"type":{"label":","},"range":[18,19]},{"type":{"label":"string"},"value":"Metric service should exist","range":[20,49]},{"type":{"label":")"},"range":[49,50]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'Metric service should exist');
});
...
test.serial('Metric#create', async t => {
  ...
  t.true(_rec7._expr(_rec7._capt(_rec7._capt(_rec7._capt(MetricStub, 'arguments/0/callee/object/object').create, 'arguments/0/callee/object').calledWith(_rec7._capt(newMetric, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(MetricStub.create.calledWith(newMetric), \'create should be called with newAgent\')',
    filepath: 'tests\\metric-tests.js',
    line: 110,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"MetricStub","range":[7,17]},"property":{"type":"Identifier","name":"create","range":[18,24]},"computed":false,"range":[7,24]},"property":{"type":"Identifier","name":"calledWith","range":[25,35]},"computed":false,"range":[7,35]},"arguments":[{"type":"Identifier","name":"newMetric","range":[36,45]}],"range":[7,46]},{"type":"StringLiteral","value":"create should be called with newAgent","range":[48,87]}],"range":[0,88]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"MetricStub","range":[7,17]},{"type":{"label":"."},"range":[17,18]},{"type":{"label":"name"},"value":"create","range":[18,24]},{"type":{"label":"."},"range":[24,25]},{"type":{"label":"name"},"value":"calledWith","range":[25,35]},{"type":{"label":"("},"range":[35,36]},{"type":{"label":"name"},"value":"newMetric","range":[36,45]},{"type":{"label":")"},"range":[45,46]},{"type":{"label":","},"range":[46,47]},{"type":{"label":"string"},"value":"create should be called with newAgent","range":[48,87]},{"type":{"label":")"},"range":[87,88]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'create should be called with newAgent');
...
test.serial('Metric#findByAgentUuid', async t => {
  ...
  t.true(_rec8._expr(_rec8._capt(_rec8._capt(_rec8._capt(MetricStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
  ...
  t.true(_rec9._expr(_rec9._capt(_rec9._capt(_rec9._capt(MetricStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
...
test.serial('Metric#findByTypeAgentUuid', async t => {
  ...
  t.true(_rec11._expr(_rec11._capt(_rec11._capt(_rec11._capt(MetricStub, 'arguments/0/object/object').findAll, 'arguments/0/object').called, 'arguments/0'), {
    content: 't.true(MetricStub.findAll.called, \'findAll should be called on model\')',
    filepath: 'tests\\metric-tests.js',
    line: 128,
    async: true,
  ...
  t.true(_rec12._expr(_rec12._capt(_rec12._capt(_rec12._capt(MetricStub, 'arguments/0/object/object').findAll, 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(MetricStub.findAll.calledOnce, \'findAll should be called once\')',
    filepath: 'tests\\metric-tests.js',
    line: 129,
    async: true,
  ...
  t.true(_rec13._expr(_rec13._capt(_rec13._capt(_rec13._capt(MetricStub, 'arguments/0/callee/object/object').findAll, 'arguments/0/callee/object').calledWith(_rec13._capt(typeAgentUuidArgs, 'arguments/0/arguments/0')), 'arguments/0'), {
    content: 't.true(MetricStub.findAll.calledWith(typeAgentUuidArgs), \'findAll should be called with typeAgentUuidArgs\')',
    filepath: 'tests\\metric-tests.js',
    line: 130,
    async: true,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"MemberExpression","object":{"type":"Identifier","name":"MetricStub","range":[7,17]},"property":{"type":"Identifier","name":"findAll","range":[18,25]},"computed":false,"range":[7,25]},"property":{"type":"Identifier","name":"calledWith","range":[26,36]},"computed":false,"range":[7,36]},"arguments":[{"type":"Identifier","name":"typeAgentUuidArgs","range":[37,54]}],"range":[7,55]},{"type":"StringLiteral","value":"findAll should be called with typeAgentUuidArgs","range":[57,106]}],"range":[0,107]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"MetricStub","range":[7,17]},{"type":{"label":"."},"range":[17,18]},{"type":{"label":"name"},"value":"findAll","range":[18,25]},{"type":{"label":"."},"range":[25,26]},{"type":{"label":"name"},"value":"calledWith","range":[26,36]},{"type":{"label":"("},"range":[36,37]},{"type":{"label":"name"},"value":"typeAgentUuidArgs","range":[37,54]},{"type":{"label":")"},"range":[54,55]},{"type":{"label":","},"range":[55,56]},{"type":{"label":"string"},"value":"findAll should be called with typeAgentUuidArgs","range":[57,106]},{"type":{"label":")"},"range":[106,107]}]',
    visitorKeys: _powerAssertVisitorKeys
  }), 'findAll should be called with typeAgentUuidArgs');
